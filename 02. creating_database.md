...
So we need to create a batch file for each job insertion, after creating a new script, we need to modify the .bat file contents, changing the folder_path and, and the target table inside the file
