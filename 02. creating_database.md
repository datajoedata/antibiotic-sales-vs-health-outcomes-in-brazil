...
### 3.4 - To create a .bat file you can copy the structure below in a .txt file and save as a .bat extension.  
 ...
 ### 3.4.1 - Bulk insertion structure for files:
...
### 3.4.2 - Bulk insertion for "b" files:
So for "b" files we need to modify the .bat file contents, change the folder_path and, and the target table. 
### 3.4.3 - Bulk insertion for "c" files:
So for "c" files we need to modify the .bat file contents, change the folder_path and, and the target table. 
### 3.4.4 - Bulk insertion for "d" files:
So for "d" files we need to modify the .bat file contents, change the folder_path and, and the target table. 
